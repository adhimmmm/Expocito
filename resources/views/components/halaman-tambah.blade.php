...
<div x-show="open" x-cloak x-transition.opacity.300ms tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-6 w-[70%] h-[100%]  mt-[45px] max-h-[800px]  bg-white rounded-lg shadow-lg">
        <!-- Modal content -->
            ...
            <form action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2" x-data="{
                    ...
                    <div>
                        ...
                        <button type="submit" onclick="return confirm('Apakah Anda yakin ingin menambah data ini?')"
